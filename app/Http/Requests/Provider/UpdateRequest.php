...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email'=>'nullable|email|string|unique:providers,email,'.
            $this->route('provider')->id.'|max:255',
            
            'nit_number'=>'nullable|string|min:15|unique:providers,nit_number,'.
            $this->route('provider')->id.'|max:15|',
            'address'=>'nullable|string|max:255',
            'phone'=>'nullable|string|min:9|unique:providers,phone,'.
